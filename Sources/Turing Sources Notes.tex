...
\begin{document}
	...
	\section{Publications, Lectures, and Talks}
		...
		\subsection{}
		\subsection{}
		\subsection{Can Digital Computers Think?\cite{amt-b-5} (1951)}
			Attempts to explain different perspectives of whether machines are effectively brains.

			Towards start, quotes Ada Lovelace.
			
			\begin{quote}
				Their outlook was well summed up by Lady Lovelace over a hundred years ago, speaking of Babbage's Analytical Engine. She said, as Hartree has already quoted, `The Analytcal Machne has no pretensions whatever whatever to orginate anything. It do whatever we know how to order it to perform.'
			\end{quote}
	...
	\section{Correspondence}
		...
		\subsection{Various Letters to Turing}
			...
			\subsubsection{Christopher Starchey; May 15, 1951}
				Regards 
