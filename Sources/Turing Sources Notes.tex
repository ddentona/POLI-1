...
\begin{document}
	...
	\section{Publications, Lectures, and Talks}
		...
		\subsection{}
		\subsection{}
		\subsection{Computing Machinery and Intelligence (1950)}
			1950 article about AI\cite{amt-b-9}.
			\subsubsection{Part 1: Imitation Game}
				Turing thinks up the imitation game: a man, a woman, and an interrogator exist. 
				The interrogator has the goal of guessing which one is the man and which is the woman.
				The man has the goal of making the interrogator guess wrong. 
				The woman has the goal of making the interrogator guess correctly.

				Turing assumes that a machine might take the place of the man.
				He questions whether the interrogator will decide wrongly more or less often if the man were replaced by a machine.
				In effect, he theorizes the LLM.

			\subsubsection{Part 2: Critique of Proposed Question}
			\subsubsection{Part 3: Machines concerned}
				Turing defines what would not be a machine and suggests digital computers.
			\subsubsection{Part 4: Digital Computers}
				
			\subsubsection{}
			\subsubsection{}
			\subsubsection{Part 7: Learning Machines}
