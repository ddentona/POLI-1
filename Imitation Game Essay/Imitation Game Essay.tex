...
\begin{document}
    ...
    When playing the Imitation Game, a topic the machine has low capacity in due to an extreme and unbalanced focus on logic uring its creation would be a breaking point.
